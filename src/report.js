...
/** Where a venue can ask for help fixing what the scanner found. */
const SUPPORT_CONTACT = 'magnoormeno@gmail.com';
...
<div class="wrap">
  ...
  <footer>
    ...
    Generated by netcafe-guard v${escapeHtml(meta.version)}. Read-only scan — nothing on the machine was changed.<br>
    Need this fixed across a venue? <a href="mailto:${SUPPORT_CONTACT}">${SUPPORT_CONTACT}</a>
  </footer>
</div>
</html>
`;
...
module.exports = { renderText, renderJson, renderHtml, COLORS, SUPPORT_CONTACT };
